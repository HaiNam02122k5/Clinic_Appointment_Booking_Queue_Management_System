...
namespace Clinic.Domain.UnitTests
{
    public class ShiftRequestTests
    {
        ...
        public void TestUpdateShiftRequestInvalid()
        {
            ...
            Assert.Throws<ArgumentException>(() => shift.UpdateShift(DateOnly.FromDateTime(now), TimeOnly.FromDateTime(now.AddHours(-2)), TimeOnly.FromDateTime(now.AddHours(1)), 5, ""));
